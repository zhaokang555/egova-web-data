 ...
 * @version 1.0.0
 */
@component({ template: '<div class="e-echarts"></div>' })
export default class ECharts extends Component
{
    ...
    private initialize(): void
    {
        ...
        if(this.autoResize)
        {
            ...
            (<any>window).addEventListener("resize", this._resizeHanlder);
        }
    ...
    private destroy(): void
    {
        if(this.autoResize)
        {
            (<any>window).removeEventListener("resize", this._resizeHanlder);
        }
